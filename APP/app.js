...
body::before {
  ...
  position: absolute;
  inset: 0;
  background-image: url('https://raw.githubusercontent.com/cncf/artwork/master/projects/kubernetes/horizontal/color/kubernetes-horizontal-color.png');
...
.logo{
  ...
  background-position:center;
  background-repeat:no-repeat;
  background-image: url('https://raw.githubusercontent.com/cncf/artwork/master/projects/kubernetes/icon/color/kubernetes-icon-color.png');
...
<div class="wrap">
  <div class="card" role="main">
    <header>
      <div class="logo"></div>
      <div><h1>APP-depi - Pod Info</h1></div>
    </header>
